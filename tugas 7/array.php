...
// Menampilkan header untuk Soal 2
echo "<h3> Soal 2</h3>";

// Menampilkan konten dari array untuk memastikan bahwa array telah dibuat dengan benar
echo "<h4>Kids:</h4>";
echo "<ul>";
foreach ($kids as $kid) {
echo "<li>$kid</li>";
...
*/ 
$arraymulti = [ ["Name"=>"Will Byers", "Age"=>"12", "Aliases"=>"Will the Wise", "Status"=>"Alive"],
